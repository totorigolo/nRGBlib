...
void drawBox(Box *box, Color c, ScreenBuffer buffer);
// Sl = slower
...
void drawSquare_(int16_t x, int16_t y, int16_t side, Color c, ScreenBuffer buffer);
void drawSquare(Square *s, Color c, ScreenBuffer buffer);
// Sl = slower
void drawSquare_Sl(int16_t x, int16_t y, int16_t side, Color c, ScreenBuffer buffer);
void drawSquareSl(Square *s, Color c, ScreenBuffer buffer);
...
void drawTriangle(Triangle *t, Color c, ScreenBuffer buffer);
