...
void drawCharBckg(short x, short y, char ch, char size, Color colT, Color colB);

/// Dessine une lettre aux positions données
void drawChar(short x, short y, char ch, char size, Color col);
...
void drawStrBckg(short x, short y, char* str, char size, char endl, Color colT, Color colB);

/// Ecris un texte aux positions données
///    - retour est un booléen qui défini si le retour à la ligne est permis
void drawStr(short x, short y, char* str, char size, char endl, Color col);
